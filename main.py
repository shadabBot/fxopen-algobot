...
class FxOpenWebSocket:
    ...
    def on_message(self, ws, message):
        ...
        if "Response" in data:
            ...
            elif data["Response"] == "Positions":
                self.positions = data["Result"]
    ...
    def get_positions(self):
        self.ws.send(json.dumps({"Id": "pos1", "Request": "Positions"}))
...
def run_bot():
    ...
    send_email("Bot Started", "Your XAUUSD bot is now LIVE via WebSocket!")
    ...
    while True:
        try:
            ...
            # Get data (simulate candles via history request)
